    ...
    <div className="fixed inset-0 bg-bg z-50 overflow-hidden flex flex-col">
      ...
      <AnimatePresence mode="wait">
        ...
        {currentScreen === 'd1_penny' && (
          ...
          >
            <div className="space-y-8 text-center">
              {d1Tapped.length > 0 ? (
                <h2 className="font-serif italic text-3xl">You detected the exact moment meaning began.</h2>
              ) : (
                <h2 className="font-serif italic text-3xl">Stories feel seamless… until you slow them down.</h2>
              )}
        ...
        {currentScreen === 'd3_penny' && (
          ...
          >
            <div className="space-y-8 text-center">
              <h2 className="font-serif italic text-3xl">The sentence stayed the same.</h2>
              <p className="text-xl opacity-60">Your position changed. That shift is separation.</p>
              <div className="pt-12">
                <p className="text-[10px] uppercase tracking-[0.3em] opacity-40">Rep Logged: Story Separation +1</p>
              </div>
