  ...
  const renderCTA = (text: string, next: Screen, disabled = false) => (
    ...
    >
      <button
        ...
        className={`bg-accent text-white px-16 py-5 rounded-xl font-medium transition-all duration-500 shadow-xl shadow-accent/10 ${disabled ? 'opacity-20 grayscale cursor-not-allowed' : 'hover:scale-105 active:scale-95 hover:shadow-accent/20'}`}
      >
        {text}
      </button>
    </motion.div>
      ...
      <AnimatePresence mode="wait">
        ...
        {currentScreen === 'edu_intro' && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="flex-1 flex flex-col items-center justify-center p-8 bg-line/50"
          >
            {renderNav()}
            <div className="text-center space-y-8 max-w-xs">
              <p className="col-header">Muscle Focus: Attention Control</p>
              <h2 className="font-serif italic text-4xl leading-tight">The education you never received.</h2>
              <p className="opacity-60">You were never taught this.</p>
        ...
        {currentScreen === 'drill1_penny' && (
          ...
          >
            <div className="space-y-8 text-center">
              <h2 className="font-serif italic text-3xl">Most reactions are rehearsed.</h2>
              <p className="text-xl opacity-60">You just interrupted one.</p>
              <div className="pt-12">
                <p className="text-[10px] uppercase tracking-[0.3em] opacity-40">Rep Logged: Attention Control +1</p>
              </div>
        ...
        {currentScreen === 'drill2_penny' && (
          ...
          >
            <div className="space-y-8 text-center">
              <h2 className="font-serif italic text-3xl">Urgency is a sensation.</h2>
              <p className="text-xl opacity-60">Not a directive.</p>
              <div className="pt-12">
                <p className="text-[10px] uppercase tracking-[0.3em] opacity-40">Rep Logged: Urgency Resistance +1</p>
              </div>
        ...
        {currentScreen === 'drill3_penny' && (
          ...
          >
            <div className="space-y-8 text-center">
              <h2 className="font-serif italic text-3xl">Your system preferred closure.</h2>
              <p className="text-xl opacity-60">You proved closure is optional.</p>
              <div className="pt-12">
                <p className="text-[10px] uppercase tracking-[0.3em] opacity-40">Rep Logged: Completion Tolerance +1</p>
              </div>
